...
urlpatterns = [
 ...
 path('', views.index_view, name='index'), # Root URL shows index.html (login page)
 path('dashboard/', views.dashboard_view, name='dashboard'), # Changed to 'dashboard' for simplicity
 path('tasks/', views.tasks_view, name='tasks'),
 path('lost-pin/', views.lost_pin_view, name='lost_pin'), # Matches template name 'lostpin.html'
 path('my-team/', views.my_team_view, name='myteam'),
